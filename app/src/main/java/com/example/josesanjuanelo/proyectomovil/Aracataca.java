...
public class Aracataca extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aracataca);
    ...
    public void puntuar(View v){
        ...
        total = total+1;
        Puntuacion n = new Puntuacion ("AR", puntos, total);
    ...
    public  void ayuda(View v){
        ...
        if (abrigo.isChecked() || bloqueador.isChecked() || kit.isChecked() || repelente.isChecked()){
            ...
            Ayuda a = new Ayuda ("AR", abrig, bloqueado, kitt, repelent, totala);
    ...
    public void mostrar_mapa (View v){
        Intent i = new Intent(Aracataca.this,Mapa_Aracataca.class);
        startActivity(i);
    }
}
