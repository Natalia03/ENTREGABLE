...
public class Baranoa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_baranoa);
    ...
    public void puntuar(View v){
        ...
        total = total+1;
        Puntuacion n = new Puntuacion ("BN", puntos, total);
    ...
    public  void ayuda(View v){
        ...
        if (abrigo.isChecked() || bloqueador.isChecked() || kit.isChecked() || repelente.isChecked()){
            ...
            Ayuda a = new Ayuda ("BN", abrig, bloqueado, kitt, repelent, totala);
