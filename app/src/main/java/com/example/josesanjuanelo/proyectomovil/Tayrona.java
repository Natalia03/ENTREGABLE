...
public class Tayrona extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tayrona);
    ...
    public void mostrar_mapa (View v){
        Intent i = new Intent(Tayrona.this,Mapa_Tayrona.class);
        startActivity(i);
    }
    ...
    public void puntuar(View v){
        ...
        total = total+1;
        Puntuacion n = new Puntuacion("TY", puntos, total);
    ...
    public  void ayuda(View v){
        ...
        if (abrigo.isChecked() || bloqueador.isChecked() || kit.isChecked() || repelente.isChecked()){
            ...
            Ayuda a = new Ayuda("TY", abrig, bloqueado, kitt, repelent, totala);
